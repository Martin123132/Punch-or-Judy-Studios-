...
- `puppet_forge.voice`: local stylized speech synthesis with line, word, and viseme timing.
...
4. Local voice synthesis creates WAV audio, line cues, word cues, and viseme timings.
