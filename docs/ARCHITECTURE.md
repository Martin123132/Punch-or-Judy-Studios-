...
- `puppet_forge.voice`: local PuppetVoice source/filter synthesis with normalization, G2P rules, engine versioning, phoneme timing, word cues, and visemes.
...
4. Local PuppetVoice synthesis turns text into phonemes, drives a glottal/noise source through resonant formant filters, then creates WAV audio, line cues, word cues, phoneme cues, and viseme timings.
