...
- `puppet_forge.voice`: local PuppetVoice formant synthesis with normalization, G2P rules, phoneme timing, word cues, and visemes.
...
4. Local PuppetVoice synthesis turns text into phonemes, then creates WAV audio, line cues, word cues, and viseme timings.
