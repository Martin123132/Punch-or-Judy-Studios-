...
- Local PuppetVoice v0.6 articulated unit-bank synthesis for the core clear-voice phrase, with source/filter fallback, line cues, word cues, phoneme cues, visemes, and engine-versioned audio regeneration.
