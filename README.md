...
- Local PuppetVoice v0.8 articulated unit-bank synthesis for the core puppet demo phrases, now with phrase prosody, stressed/soft word flow, shorter unit-word gaps, punctuation pauses, source/filter fallback, line cues, word cues, phoneme cues, visemes, and engine-versioned audio regeneration.
