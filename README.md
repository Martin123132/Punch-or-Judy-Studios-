...
- Local PuppetVoice v0.7 articulated unit-bank synthesis for the core puppet demo phrases, with source/filter fallback, line cues, word cues, phoneme cues, visemes, and engine-versioned audio regeneration.
